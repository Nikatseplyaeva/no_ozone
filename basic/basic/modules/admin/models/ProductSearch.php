...
class ProductSearch extends Product
{
    ...
    {
        return [
            [['id', 'flag', 'id_company', 'id_category'], 'integer'],
            [['name', 'description', 'characrteristic', 'mode_of_application', 'created_at', 'updated_at', 'created_by'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'characrteristic', $this->characrteristic])
